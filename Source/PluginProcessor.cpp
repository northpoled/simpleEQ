...
void SimpleEQAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
    ...
    // whose contents will have been created by the getStateInformation() call.e
...
void SimpleEQAudioProcessor::updatePeakFilter(const ChainSettings& chainSettings)
{
    ...
    updateCoefficients(leftChain.get<ChainPositions::Parametric>().coefficients, peakCoefficients);
    updateCoefficients(rightChain.get<ChainPositions::Parametric>().coefficients, peakCoefficients);
}
...
void SimpleEQAudioProcessor::updateHighCutFilters(const ChainSettings &chainSettings)
{
    ...
    auto& leftHighCut = leftChain.get<ChainPositions::HighCutFilter>();
    auto& rightHighCut = rightChain.get<ChainPositions::HighCutFilter>();
